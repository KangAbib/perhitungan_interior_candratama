...
import 'package:ganesha_interior/Invoice/INV_lemari.dart';
...
class _LemariScreenState extends State<LemariScreen> {
  TextEditingController LemariController = TextEditingController(text: "Rp ");
          ...
          children: [
            Expanded(
              ...
              child: ElevatedButton(
                onPressed: () {
                  tambahKeKeranjang("Lemari", hitungSubTotal());
                },
