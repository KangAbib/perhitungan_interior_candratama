...
class INV_BackdropTV extends StatefulWidget {
  const INV_BackdropTV({super.key});

  @override
  State<INV_BackdropTV> createState() => _INV_Partsi();
}

class _INV_Partsi extends State<INV_BackdropTV> {
  ...
  try {
    ...
    await Printing.sharePdf(
      ...
      filename: 'Inv_backdrop tv_$nama.pdf',
    );
  } catch (e) {
              ...
              Container(
                      ...
                      child: Table(
                        ...
                        children: [
                          ...
                          _buildTableRow(
                            ["Backdrop TV", hargaBackdropTV, ukuranBackdropTV, jumlah],
                            context: context,
                          ),
