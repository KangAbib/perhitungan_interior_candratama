...
class INV_Minibar extends StatefulWidget {
  const INV_Minibar({super.key});

  @override
  State<INV_Minibar> createState() => _INV_Minibar();
}

class _INV_Minibar extends State<INV_Minibar> {
  String nama = "Memuat...";
  String alamat = "";
  String hargaMinibar = "";
  String jumlahAtas = "";
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    "Pembayaran : ${isTablet ? "Minibar set" : "Minibar set"}",
                    style: TextStyle(
