...
import 'package:ganesha_interior/Invoice/INV_meja_island.dart';
...
class _MejaIslandState extends State<MejaIsland> {
  TextEditingController mejaislandController =
  ...
  void initState() {
    ...
    _setupControllerListener(mejaislandController);
    _setupControllerListener(ukuranmejaislandController);
  ...
  void tambahItemField() {
    ...
    _hitungMejaisland(); // hitung ulang setelah penambahan
  }
  ...
  void _hitungMejaisland() {
    ...
    double ukuranMejaisland = parseUkuran(ukuranmejaislandController.text);
    double hargaMejaisland = parseHarga(mejaislandController.text);
    double totalHargaItem = 0;
    for (var controller in hargaItemControllers) {
      totalHargaItem += parseHarga(controller.text);
    }

    double totalHarga = ukuranMejaisland * hargaMejaisland;
    double total = totalHarga + totalHargaItem;
    double uangMuka = total * 0.6;

    print(
        "Ukuran: $ukuranMejaisland, Harga: $hargaMejaisland, Total: $totalHarga");
  ...
  double hitungSubTotal() {
    ...
    return (ukuranMejaIsland * hargaMejaIsland) + totalHargaItem;
  }
  ...
  void simpanDataKeFirestore() async {
    if (namaController.text.isEmpty ||
        ...
        ukuranmejaislandController.text.isEmpty ||
        mejaislandController.text.isEmpty) {
    ...
    print("Ukuran Meja Island: ${ukuranmejaislandController.text}");
    print("Harga Meja Island: ${mejaislandController.text}");
    ...
    double ukuranMejaisland = parseValue(ukuranmejaislandController.text);
    double hargaMejaisland = parseValue(mejaislandController.text);
  ...
  double screenWidth = MediaQuery.of(context).size.width;
    ...
    context,
    MaterialPageRoute(
      builder: (context) => const INV_MejaIsland(),
    ),
  );
} catch (e) {
  ScaffoldMessenger.of(context).showSnackBar(
  ...
  @override
  void dispose() {
    mejaislandController.dispose();
    uangMukaController.dispose();
    jumlahController.dispose();
    namaController.dispose();
    alamatController.dispose();
    ukuranmejaislandController.dispose();
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: TextField(
                                          controller: mejaislandController,
                                          style: GoogleFonts.manrope(
                                            fontSize: screenWidth * 0.04,
                                            fontWeight: FontWeight.w400,
                                          ),
          ...
          children: [
            Expanded(
              ...
              child: ElevatedButton(
                onPressed: () {
                  tambahKeKeranjang("Meja Island", hitungSubTotal());
                },
